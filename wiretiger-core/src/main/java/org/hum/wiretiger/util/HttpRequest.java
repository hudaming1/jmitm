...
public class HttpRequest implements Serializable {
	...
	public boolean isHttps() {
		return HttpHelper.HTTPS_METHOD.equalsIgnoreCase(method);
	}
	...
	public String getUri() {
		...
		return HttpHelper.parse2RelativeFile(url);
	}
	...
	public String toString() {
		...
		// request-line
		sbuilder.append(line).append(HttpHelper.RETURN_LINE);
		// request-headers
		for (Entry<String, String> header : headers.entrySet()) {
			sbuilder.append(header.getKey()).append(":").append(header.getValue()).append(HttpHelper.RETURN_LINE);
		}
		//
		sbuilder.append(HttpHelper.RETURN_LINE);
